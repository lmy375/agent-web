...
SVG assets from [LobeHub Icons](https://github.com/lobehub/lobe-icons), retrieved
2026-09-16. Bundled locally so the UI does not depend on third-party image hosts.
